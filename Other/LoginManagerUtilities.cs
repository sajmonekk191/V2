...
namespace VoidSharp.Other
{
    class LoginManagerUtilities
    {
        ...
        {
            if (am.selectedCB1.Checked == true && am.selectedCB2.Checked == false && am.selectedCB3.Checked == false && am.selectedCB4.Checked == false && am.selectedCB5.Checked == false && am.selectedCB6.Checked == false && am.selectedCB7.Checked == false && am.selectedCB8.Checked == false)
            {
                am.LBLselectedACC.Text = "1";
                am.LBLselectedUSER.Text = Properties.Settings.Default.Username1;
                am.LBLselectedPASS.Text = Properties.Settings.Default.Password1;
            ...
            else if (am.selectedCB1.Checked == false && am.selectedCB2.Checked == true && am.selectedCB3.Checked == false && am.selectedCB4.Checked == false && am.selectedCB5.Checked == false && am.selectedCB6.Checked == false && am.selectedCB7.Checked == false && am.selectedCB8.Checked == false)
            {
                am.LBLselectedACC.Text = "2";
                am.LBLselectedUSER.Text = Properties.Settings.Default.Username2;
                am.LBLselectedPASS.Text = Properties.Settings.Default.Password2;
                hodnoty.CurentUsername = Properties.Settings.Default.Username2;
                hodnoty.CurentPassword = Properties.Settings.Default.Password2;
            }
            else if (am.selectedCB3.Checked == true)
            {
                am.LBLselectedACC.Text = "3";
                am.LBLselectedUSER.Text = Properties.Settings.Default.Username3;
                am.LBLselectedPASS.Text = Properties.Settings.Default.Password3;
                hodnoty.CurentUsername = Properties.Settings.Default.Username3;
                hodnoty.CurentPassword = Properties.Settings.Default.Password3;
            }
            else if (am.selectedCB4.Checked == true)
            {
                am.LBLselectedACC.Text = "4";
                am.LBLselectedUSER.Text = Properties.Settings.Default.Username4;
                am.LBLselectedPASS.Text = Properties.Settings.Default.Password4;
                hodnoty.CurentUsername = Properties.Settings.Default.Username4;
                hodnoty.CurentPassword = Properties.Settings.Default.Password4;
            }
            else if (am.selectedCB5.Checked == true)
            {
                am.LBLselectedACC.Text = "5";
                am.LBLselectedUSER.Text = Properties.Settings.Default.Username5;
                am.LBLselectedPASS.Text = Properties.Settings.Default.Password5;
                hodnoty.CurentUsername = Properties.Settings.Default.Username5;
                hodnoty.CurentPassword = Properties.Settings.Default.Password5;
            }
            else if (am.selectedCB6.Checked == true)
            {
                am.LBLselectedACC.Text = "6";
                am.LBLselectedUSER.Text = Properties.Settings.Default.Username6;
                am.LBLselectedPASS.Text = Properties.Settings.Default.Password6;
                hodnoty.CurentUsername = Properties.Settings.Default.Username6;
                hodnoty.CurentPassword = Properties.Settings.Default.Password6;
            }
            else if (am.selectedCB7.Checked == true)
            {
                am.LBLselectedACC.Text = "7";
                am.LBLselectedUSER.Text = Properties.Settings.Default.Username7;
                am.LBLselectedPASS.Text = Properties.Settings.Default.Password7;
                hodnoty.CurentUsername = Properties.Settings.Default.Username7;
                hodnoty.CurentPassword = Properties.Settings.Default.Password7;
            }
            else if (am.selectedCB8.Checked == true)
            {
                am.LBLselectedACC.Text = "8";
                am.LBLselectedUSER.Text = Properties.Settings.Default.Username8;
                am.LBLselectedPASS.Text = Properties.Settings.Default.Password8;
        ...
        {
            //checkbox1
            if (am.selectedCB1.Checked == true && am.selectedCB2.Checked == false && am.selectedCB3.Checked == false && am.selectedCB4.Checked == false && am.selectedCB5.Checked == false && am.selectedCB6.Checked == false && am.selectedCB7.Checked == false && am.selectedCB8.Checked == false) return true;
            //checkbox2
            if (am.selectedCB1.Checked == false && am.selectedCB2.Checked == true && am.selectedCB3.Checked == false && am.selectedCB4.Checked == false && am.selectedCB5.Checked == false && am.selectedCB6.Checked == false && am.selectedCB7.Checked == false && am.selectedCB8.Checked == false) return true;
            //checkbox3
            if (am.selectedCB1.Checked == false && am.selectedCB2.Checked == false && am.selectedCB3.Checked == true && am.selectedCB4.Checked == false && am.selectedCB5.Checked == false && am.selectedCB6.Checked == false && am.selectedCB7.Checked == false && am.selectedCB8.Checked == false) return true;
            //checkbox4
            if (am.selectedCB1.Checked == false && am.selectedCB2.Checked == false && am.selectedCB3.Checked == false && am.selectedCB4.Checked == true && am.selectedCB5.Checked == false && am.selectedCB6.Checked == false && am.selectedCB7.Checked == false && am.selectedCB8.Checked == false) return true;
            //checkbox5
            if (am.selectedCB1.Checked == false && am.selectedCB2.Checked == false && am.selectedCB3.Checked == false && am.selectedCB4.Checked == false && am.selectedCB5.Checked == true && am.selectedCB6.Checked == false && am.selectedCB7.Checked == false && am.selectedCB8.Checked == false) return true;
            //checkbox6
            if (am.selectedCB1.Checked == false && am.selectedCB2.Checked == false && am.selectedCB3.Checked == false && am.selectedCB4.Checked == false && am.selectedCB5.Checked == false && am.selectedCB6.Checked == true && am.selectedCB7.Checked == false && am.selectedCB8.Checked == false) return true;
            //checkbox7
            if (am.selectedCB1.Checked == false && am.selectedCB2.Checked == false && am.selectedCB3.Checked == false && am.selectedCB4.Checked == false && am.selectedCB5.Checked == false && am.selectedCB6.Checked == false && am.selectedCB7.Checked == true && am.selectedCB8.Checked == false) return true;
            //checkbox8
            if (am.selectedCB1.Checked == false && am.selectedCB2.Checked == false && am.selectedCB3.Checked == false && am.selectedCB4.Checked == false && am.selectedCB5.Checked == false && am.selectedCB6.Checked == false && am.selectedCB7.Checked == false && am.selectedCB8.Checked == true) return true;
